...
f3 = Folder.create(id: UUID.new.generate, name: "React")
...
n2 = Note.create(id: UUID.new.generate, title: Faker::Artist.name, body: "Art stuff", folder: f1)
n3 = Note.create(id: UUID.new.generate, title: "ActiveRecord", body: "Made with Sinatra ActiveRecord", folder: f2)
n4 = Note.create(id: UUID.new.generate, title: "JavaScript", body: "Made with React", folder: f3)
...
r2 = NoteTag.create(note: n1, tag: t5)
r3 = NoteTag.create(note: n2, tag: t3)
r4 = NoteTag.create(note: n3, tag: t2)
r5 = NoteTag.create(note: n3, tag: t1)
